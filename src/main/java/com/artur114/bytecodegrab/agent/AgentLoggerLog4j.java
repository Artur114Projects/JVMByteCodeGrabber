...
public class AgentLoggerLog4j implements IAgentLogger {
    ...
    public void warn(String log, Object arg) {
        ...
        try {
            this.logger.warn(log, new Object[]{arg});
        } catch (Throwable e) {
            this.down = true;
        }
    }
    ...
    public void info(String log, Object arg) {
        ...
        try {
            this.logger.info(log, new Object[]{arg});
        } catch (Throwable e) {
            this.down = true;
        }
    }
    ...
    public void error(String log, Object arg) {
        ...
        try {
            this.logger.error(log, new Object[]{arg});
        } catch (Throwable e) {
            this.down = true;
        }
    }
    ...
    public void warn(String log, Object arg, Object arg1) {
        ...
        try {
            this.logger.warn(log, new Object[]{arg, arg1});
        } catch (Throwable e) {
            this.down = true;
        }
    }
    ...
    public void info(String log, Object arg, Object arg1) {
        ...
        try {
            this.logger.info(log, new Object[]{arg, arg1});
        } catch (Throwable e) {
            this.down = true;
        }
    }
    ...
    public void error(String log, Object arg, Object arg1) {
        ...
        try {
            this.logger.error(log, new Object[]{arg, arg1});
        } catch (Throwable e) {
            this.down = true;
        }
    }
